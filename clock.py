...
clock=Label(root,font=("times",60,"bold"),bg="lightblue")
clock.grid(row=2,column=2,pady=50,padx=100)
timing()
#create a variable for digital clock
digital=Label(root,text="Sumit's Digital Clock",font="times 24 bold",bg="blue")
digital.grid(row=0,column=2) 
nota=Label(root,text="Hours        Minutes        Seconds",font="roman 15 bold", bg="blue")
